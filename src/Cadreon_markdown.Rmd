...
Ensure knitr outputs to correct folder
```{r "setup", include=FALSE}
require("knitr")
opts_knit$set(root.dir = "outputs/")
```
...
## Question 2
A plot of sales, TV and digital investment is below. There does not appear to be any time trend in sales, except for a positive linear growth. This increase does not appear to coincide with corresponding increases in TV or Digital sales.
